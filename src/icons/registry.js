const fill = path => ({ viewBox: '0 0 24 24', body: `<path fill="currentColor" d="${path}"/>` });
const stroke = body => ({
  viewBox: '0 0 24 24',
...
export const iconRegistry = Object.freeze({
  ...
  bolt: fill('M13 2a1 1 0 0 1 1 1v6h5a1 1 0 0 1 .808 1.588l-8 11A1 1 0 0 1 10 21v-6H5a1 1 0 0 1-.808-1.588l8-11A1 1 0 0 1 13 2Z'),
});
